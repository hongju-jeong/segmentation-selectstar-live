...
import requests
import json
import settings_tmap
#import currentgps
def get_location(destination):
    
    center_lon, center_lat = 127.083362949041, 37.24044601170735#currentgps.get_gps()##  #currentgps.get_gps()
    print(center_lon, center_lat)
    tmap_location_url = "https://apis.openapi.sk.com/tmap/pois?version=1&format=json&callback=result"

    rest_api_key = settings_tmap.get_apiKey('rest_api_key')
