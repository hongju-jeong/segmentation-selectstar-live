...
### RUN OPTIONS ###
BASE_DIR = Path('/media/muzy/새 볼륨/images/인도보행 영상/서피스마스킹')
XML_GLOB = Path(BASE_DIR) / '**/*.xml'
OUTPUT_DIR = Path('/media/muzy/새 볼륨/images/outputdir')
...
"sidewalk@urethane": [0, 255, 0],  # sidewalk
"sidewalk@asphalt": [0, 255, 0],  # sidewalk
"sidewalk@soil_stone": [0, 255, 0],  # sidewalk
"sidewalk@damaged": [0, 255, 0],  # sidewalk
"sidewalk@other": [0, 255, 0],  # sidewalk
"braille_guide_blocks@normal": [0, 255, 0],  # sidewalk
"braille_guide_blocks@damaged": [0, 255, 0],  # sidewalk
"roadway@normal": [255, 128, 0],  # roadway
"roadway@crosswalk": [255, 0, 255],  # crosswalk
"alley@normal": [255, 128, 0],  # roadway
"alley@crosswalk": [255, 0, 255],  # crosswalk
"alley@speed_bump": [255, 128, 0],  # roadway
"alley@damaged": [255, 128, 0],  # roadway
"bike_lane@normal": [0, 255, 0],  # sidewalk
"caution_zone@stairs": [0, 0, 0],  # background
"caution_zone@manhole": [0, 0, 0],  # background
"caution_zone@tree_zone": [0, 0, 0],  # background
"caution_zone@grating": [0, 0, 0],  # background
"caution_zone@repair_zone": [0, 0, 0],  # background
}
###################
