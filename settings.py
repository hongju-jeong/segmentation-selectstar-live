...
resize_height = 480  # model input shape
resize_width = 640
...
checkpoint = './run/surface/deeplab/experiment_8/checkpoint.pth.tar'

checkname = "deeplab"  # set the checkpoint name

ft = False  # finetuning on a different dataset
eval_interval = 1  # evaluation interval (default: 1)
...
if dataset == 'pascal':
    ...
    root_dir = '/media/muzy/새 볼륨/images/outputdir'
else:
